...
Data-Bindingで本来やりたいことは、Pureなモデルが書き換わったらViewに反映させることだと思うが、
その思想は踏襲しているつもり。
**記述の簡略化のために部分的にVue.jsなどを使うのはアリ。**

http://tech.nitoyon.com/ja/blog/2014/07/18/data-binding/

Object.observe()が使えるようになったら使ってみたいですね。
...
DOM操作周りに関してはライブラリを使ったほうが楽なので、別途追加しますが、それはプロジェクトによる。

大規模アプリケーションにおいては、全てSingleでやるとカオスになるので、
Single-Pageを複数用意する形にする。（○○機能ではグラフなどのライブラリを追加。✕✕機能ではanimation追加。など）

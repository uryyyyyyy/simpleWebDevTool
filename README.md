...
* data-bindingは、ちゃんと理解してると楽だけど、融通が効かない・データがDOMの構造に依存する。
...
記述が減って便利だけど、Modelの構造がDOMに依存してしまう。
...
学習コストが減る。（この2つ位は大体知ってる＆理解しやすいかと。）
